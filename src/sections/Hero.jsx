...
const Hero = () => {
  ...
  return (
    <section id="home " className="w-full flex  gap-10 max-container
     xl:flex-row flex-col justify-center min-h-screen">
      ...
      w-full max-xl:padding-x pt-28">
        ...
        <p className=" font-montserrat text-slate-gray leading-8 text-lg mt-6
        mb-14 sm:max-w-sm">Discover stylish Nike arrivals,quality comfort, and innocation for your active life</p>
      ...
      <div className="relative justify-center items-center flex flex-1 xl:min-h-screen
